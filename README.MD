...
DER[`../diagramas/DER_SOA_TP1.drawio (1).svg`](../diagramas/DER_SOA_TP1.drawio (1).svg)

**Script completo:** [`resources/db/schema.sql`](../ConsorCio-Plus/resources/db/schema.sql)
